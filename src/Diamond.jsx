...
const Diamond = ({value = 0,width = 30, height=30, stroke="red", text="white", strokeWidth="2", ...rest}) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 40 40"
  ...
  >
    ...
    <text stroke="none" style={{fontSize:19}} fill={text} textAnchor="middle" x="20" y="28">{value}</text>
  </svg>
)
